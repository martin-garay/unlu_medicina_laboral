...
return [
    ...
    'aviso' => [
        ...
        'prompts' => [
            'fecha_desde' => 'Ingresá la fecha de inicio de la ausencia en formato :date_format.',
            'fecha_hasta' => 'Ingresá la fecha de finalización de la ausencia en formato :date_format.',
        ...
        'pendiente_confirmacion_siguiente_etapa' => 'Los datos principales del aviso quedaron registrados en borrador. El siguiente paso será la confirmación final del aviso.',
        'pendiente_familiar_siguiente_etapa' => 'El tipo de ausentismo seleccionado requiere datos de familiar. Ese subflujo queda preparado para la siguiente etapa.',
